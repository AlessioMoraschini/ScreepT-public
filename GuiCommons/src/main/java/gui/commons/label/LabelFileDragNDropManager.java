...
public class LabelFileDragNDropManager extends JLabel{
	private static final long serialVersionUID = 6345611258321094551L;

	// KeyGenPanel logger
	static Logger logger = Logger.getLogger(LabelFileDragNDropManager.class); 
    ...
    // constructor
    public LabelFileDragNDropManager(Runnable dropAction, Component targetDrop) {
    ...
    public class DragUpdate implements Runnable {
        ...
        @Override
        public void run() {
            LabelFileDragNDropManager.this.dragOver = dragOver;
            LabelFileDragNDropManager.this.dragPoint = dragPoint;
            LabelFileDragNDropManager.this.repaint();
        }
    }
