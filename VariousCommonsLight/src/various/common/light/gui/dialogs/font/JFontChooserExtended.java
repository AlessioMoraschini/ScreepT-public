 ...
 */
package various.common.light.gui.dialogs.font;
...
public class JFontChooserExtended extends JComponent {
	private static final long serialVersionUID = 2985427256723426264L;
	
	private static final Font DEFAULT_SELECTED_FONT = new Font(Font.SERIF, Font.PLAIN, 14);
	...
	private static String TEST_STRING = "Always be a poet, even in prose. (C. Baudelaire)";
	 ...
	 **/
	public JFontChooserExtended()
	{
		this(DEFAULT_FONT_SIZE_STRINGS);
	}

	public JFontChooserExtended(Locale locale) {
	 ...
	 **/
	public JFontChooserExtended(String[] fontSizeStrings) {
		this(fontSizeStrings, Locale.getDefault());
	}
	public JFontChooserExtended(String[] fontSizeStrings, Locale locale)
	{
		setLocale(locale);
	...
	protected class DialogOKAction extends AbstractAction {
		private static final long serialVersionUID = -8294684666815400431L;
	...
	protected class DialogCancelAction extends AbstractAction {
		private static final long serialVersionUID = 1875112853108834523L;
	...
	public int showDialog(Component parent)
	{
		...
		GuiUtils.centerComponent(dialog, 1100, 450);
		dialog.setFont(new Font("Segoe UI", Font.PLAIN, 18));
	...
	protected JDialog createDialog(Component parent)
	{
		...
		JDialog dialog = new JDialog(frame, msg("Font Selector"), true);
	...
	protected JTextField getSampleTextField()
	{
		if (sampleText == null)
		{
			...
			sampleText = new JTextField(TEST_STRING);
			sampleText.setBorder(lowered);
			sampleText.setPreferredSize(new Dimension(300, 120));
