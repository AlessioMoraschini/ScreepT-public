...
//		if (!CalculatorMainApp.keyListenerSimpleAdded) {
//			CalculatorMainApp.keyListenerSimpleAdded = DigitKeyBaseListener.addRightListenerForClass(this);
//		}
	}
	...
	public static void main(String args[]) {
		...
		jFrame.setLocationRelativeTo(CalculatorMainApp.parentCallerFrame);
	}


	public JButton[] getjButtonNumerical() {
		return jButtonNumerical;
	}


	public void setjButtonNumerical(JButton[] jButtonNumerical) {
		this.jButtonNumerical = jButtonNumerical;
	}


	public JButton[] getjButtonOperator() {
		return jButtonOperator;
	}


	public void setjButtonOperator(JButton[] jButtonOperator) {
		this.jButtonOperator = jButtonOperator;
	}
